...
public class JwtHandshakeInterceptor implements HandshakeInterceptor {
  ...
  public boolean beforeHandshake(
    ...
    Optional<JwtPrincipal> principal = resolveToken(request).flatMap(jwtValidator::authenticate);
    ...
    attributes.put(WebSocketAttributes.AUTHORITIES, new ArrayList<>(principal.get().authorities()));
    return true;
  }
