 ...
 * (ai-service) and a single load-balanced one, carrying the internal token, for every call to
 * another service's {@code /internal/**} API.
 */
@Configuration
public class RestClientConfig {
  ...
  /** Plain builder for direct URLs; primary so the discovery client does not pick up the other. */
  @Bean
  @Primary
