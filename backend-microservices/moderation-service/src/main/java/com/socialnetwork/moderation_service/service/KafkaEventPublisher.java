 ...
 * an action for a moderation log row that was rolled back. Records are sent as objects (the
 * configured {@code JacksonJsonSerializer} encodes them) and keyed by the target id.
 */
@Slf4j
@Component
