...
public class ModerationController {
    ...
    @PreAuthorize("hasAuthority('MODERATION:ACCESS')")
    public ResponseEntity<PageVO<Map<String, Object>>> getFlaggedPosts(
            @RequestParam(required = false) String filter,
            @ParameterObject Pageable pageable
    ) {
    ...
    @PreAuthorize("hasAuthority('MODERATION:ACCESS')")
    public ResponseEntity<PageVO<Map<String, Object>>> getFlaggedComments(
            @RequestParam(required = false) String filter,
            @ParameterObject Pageable pageable
    ) {
    ...
    public ResponseEntity<Map<String, String>> blockUser(
        ...
        moderationService.updateUserStatus(id, "BLOCKED", reason);
    ...
    public ResponseEntity<Map<String, String>> unblockUser(
        ...
        String reason = (request != null) ? request.get("reason") : "";
        moderationService.updateUserStatus(id, "ACTIVE", reason);
        return ResponseEntity.ok(Map.of(
